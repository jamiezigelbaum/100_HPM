...
twitter.start = function(data)
{
    ...
    if(data == true){
        search.testadd({'user_screen_name':'thedantheman','tweet_text':'@thedantheman "Bob Ross"'});
        search.testadd({'user_screen_name':'thedantheman','tweet_text':'@thedantheman "jeopardy"'});
    }
};
