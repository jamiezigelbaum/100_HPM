...
var YouTube = function() {
  ...
  * @param {function} callback
  https://www.youtube.com/results?search_sort=video_date_uploaded&search_query=hour&lclk=rm%3Avideo
  */
  self.search = function(query, maxResults, callback) {
    ...
    if (validate !== null) {
      ...
      self.addParam('videoDefinition', 'standard');
      // self.addParam('safeSearch', 'none');
      self.addParam('videoDuration', "short");
